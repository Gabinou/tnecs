...
struct Simplecs_World * tnecs_init() {
    ...
    // tnecs_world->component_typehash = NULL;
    // hmdefault(tnecs_world->component_typehash, TNECS_NULL);

    // tnecs_world->component_id = NULL;
    // hmdefault(tnecs_world->component_id, TNECS_NULL);
